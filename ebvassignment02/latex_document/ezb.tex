...
Jede Sortierschale bekommt im Verlauf der Qualitätskontrolle einen entsprechenden Ausgang zugeordnet, der sich auf die einzelnen Qualitäts- und Größenklassen bezieht.
 ...
 Annika: Nein, wieso sollte dann der komplette Spargel aussortiert werden? Meinst du den fehlerhaften Spargel oder den zu kurzen Spargel, der dann als Spargelspitzen weiterverwendet wird.}
...
Die Weiterverarbeitung erfolgt durch Mitarbeiter, wodurch der Spargel ein weiteres Mal gesichtet wird.
 \todo[inline]{Macht das der Spargel mit, fallengelassen zu werden? Alternativ wieder durch Mitarbeiter kontrollieren.
Annika: Ich habe noch einen Satz hinzugefügt, aber ich würde den eigentlich weglassen.}
