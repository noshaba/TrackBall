...
\end{equation}
\linebreak
(\textbf{ODER:} Matrizenterme alle streichen und- meine bevorzugte variante, weil ich mir über die Winkel nicht sicher bin) Für die Transformationsmatrix muss nur die Rotation um Z und Y berücksichtigt werden, da die Kamera immer auf einer Höhe stehen bleibt, verändert sich der Winkel um X nicht.\\
\linebreak
