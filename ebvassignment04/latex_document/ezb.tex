...
\todo[inline]{Nur die Komponenten der Kameragleichung erklären und darauf verweisen dass die zusammen Tw<-b ergeben.}
...
\end{figure}
\todo[inline]{Skalierungsfaktor vor den ganzen Term schieben}
