...
\todo[inline]{Verfahren über die Tiefenschärfe erläutern (Frank)}
% Bahngleichung
...
Da $v_y$ beim Maximum der Bahnkurve gleich 0 ist, lässt sich die Gleichung nach $v_0$ umstellen. Bei $\Delta t$ handelt es sich um die vergangene Zeit von $t_1$ bis $t_2$, wie in Abbildung \ref{} zu sehen ist (Vergangene Zeit vom Startpunkt bis zur maximalen erreichten Höhe).
