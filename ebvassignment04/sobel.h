...
/*! Computes the sobelX and sobelY filter on \c srcImg (scaled by 1/8)
 ...
 \c dstImg is a 16bit int image of same format as \c srcImg.
...
//! Fast C implementation of \c sobel
...
/*! Hint: If you don't experience a performance improvement this might
    be because you need to activate openMP in your IDE. Usually there
    is no error message if openMP is used but not activated.
*/
